...
const variants = {
  primary:
    "bg-[color:var(--teal-deep)] text-white shadow-[0_14px_30px_rgba(17,75,95,0.18)] hover:-translate-y-0.5 hover:bg-[color:var(--teal)] cursor-pointer disabled:cursor-not-allowed disabled:opacity-70",
  secondary:
