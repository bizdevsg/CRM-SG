    ...
    >
      ...
      <div className="mb-32 space-y-6">
        <section className="space-y-4 p-4" id="profile" ref={registerSection("profile")}>
          {companyBrand ? (
            <div className="absolute left-6 top-6 z-50">
              {companyBrand.logoSrc ? (
                ...
                <div className="inline-flex min-h-14 min-w-14 items-center justify-center rounded-2xl bg-emerald-700 px-4 text-sm font-bold tracking-[0.18em] text-white">
          ...
          <div className="relative min-h-[520px] overflow-hidden rounded-xl bg-[linear-gradient(145deg,rgba(5,150,105,0.24)_0%,rgba(236,253,245,0.96)_42%,rgba(255,255,255,0.98)_100%)]">
          ...
          <div className="flex flex-col gap-2">
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-3 rounded-xl bg-emerald-700 px-7 py-2 text-white"
            ...
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-3 rounded-xl border border-emerald-200 px-5 py-2 text-emerald-800"
            >
          ...
          <div className="mt-7 grid grid-cols-4 gap-2">
            {infoItems.map((item) => (
              <div key={item.id} className="aspect-square rounded-3xl border border-emerald-200 bg-emerald-50 p-2 text-center">
        ...
        <section id="legality" ref={registerSection("legality")} className="space-y-4 bg-emerald-50/70 p-4">
          <div className="flex items-center justify-between">
            <h5 className="text-2xl font-bold">Legal Integrity</h5>
            <div className="w-fit rounded-full border border-emerald-300 bg-emerald-100 px-2 py-1 text-emerald-800">
        ...
        <section id="corporate" ref={registerSection("corporate")} className="scroll-mt-28 space-y-4 p-4">
          ...
          <div className="space-y-8">
            <div className="space-y-2">
              <h6 className="text-xl font-bold text-emerald-800">{company?.name || "Profil Perusahaan"}</h6>
              <p className="text-justify md:text-lg">
                {company?.description || "Isi desain dan copy Kontak Perkasa Futures nanti kamu bisa bedakan di sini."}
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-0.5 overflow-hidden rounded-3xl text-center shadow">
              {corporateStats.map((item) => (
                <div key={item.id} className="flex flex-col items-center justify-center bg-white p-4">
                  <h5 className="break-words text-2xl font-bold text-emerald-800 md:text-3xl">{item.value}</h5>
        ...
        <div className="p-4">
          <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-7">
            <div className="flex items-center gap-2">
              ...
              <h6 className="text-xl font-bold text-emerald-800">Anti-Fraud Notice</h6>
            </div>
